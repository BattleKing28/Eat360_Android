...
public class SearchFoodByMealIdAPI extends AsyncTask<String, Void, String> {
    ...
    public  interface ResultCallback{
        public void searchFoodByMealIdResultCallback(String jsonStringResult);
    }

    public SearchFoodByMealIdAPI(Context context,String restaurantId,String mealID){
        mContext = context;
    ...
    protected String doInBackground(String... url) {
        ...
        try {
            ...
            if(url != null && url.length>0){
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).foodByMealUrl;
                else
                    apiUrl = url[0];
