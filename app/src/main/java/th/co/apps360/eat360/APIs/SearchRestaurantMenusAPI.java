...
public class SearchRestaurantMenusAPI extends AsyncTask<String, Void, String> {
    ...
    public  interface ResultCallback{
        public void searchRestaurantMenusResultCallback(String jsonStringResult);
    }

    public SearchRestaurantMenusAPI(Context context,String restaurantId){
        mContext = context;
    ...
    protected String doInBackground(String... url) {
        ...
        try {
            ...
            if(url != null && url.length>0){
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).allRestaurantMenuUrl;
                else
                    apiUrl = url[0];
    ...
    protected void onPostExecute(String jsonString) {
        ...
        Utils.setDebug("json SearchFoodByMealIdAPI", jsonString);
