...
public class LoginAPI extends AsyncTask<String, Void, String> {
    ...
    public interface ResultCallback {
        void loginCallback(String jsonStringResult);
    }

    public LoginAPI(Context context, String email, String password) {
        mContext = context;
        mEmail = email;
        mPassword = password;
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String apiUrl = new ConfigURL().loginURL;
    ...
    protected void onPostExecute(String jsonString) {
        resultCallback.loginCallback(jsonString);
        Utils.setDebug("json LoginAPI", jsonString);
    }
