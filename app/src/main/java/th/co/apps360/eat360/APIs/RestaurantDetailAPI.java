...
public class RestaurantDetailAPI extends AsyncTask<String, Void, String> {
    ...
    public  interface ResultCallback{
        void restaurantAPIResultCallback(String jsonStringResult);
    }

    public RestaurantDetailAPI(Context context, String restaurantId){
        mContext = context;
    ...
    protected String doInBackground(String... url) {
        ...
        try {
            ...
            if(url != null && url.length>0){
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).restaurantDetailURL;
                else
                    apiUrl = url[0];
            }else
                apiUrl = new ConfigURL(mContext).restaurantDetailURL;
    ...
    protected void onPostExecute(String jsonString) {
        ...
        resultCallback.restaurantAPIResultCallback(jsonString);
        Utils.setDebug("json RestaurantDetailAPI", jsonString);
    }
}
