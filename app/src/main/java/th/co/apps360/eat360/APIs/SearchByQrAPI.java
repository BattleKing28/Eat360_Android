...
public class SearchByQrAPI extends AsyncTask<String, Void, String> {
    ...
    public SearchByQrAPI(Context context, String webUrl){
        mContext = context;
    ...
    protected String doInBackground(String... url) {
        ...
        try {
            ...
            if(url != null && url.length>0){
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).searchByQrURL;
                else
                    apiUrl = url[0];
            ...
            nameValuePairs.add(new BasicNameValuePair("URL", webUrl));
    ...
    protected void onPostExecute(String jsonString) {
        ...
        resultCallback.searchByQrResultCallback(jsonString);
        Utils.setDebug("json SearchByQrAPI", jsonString);
    }
}
