...
public class FoodIngredientsAPI extends AsyncTask<String, Void, String> {
    ...
    public  interface ResultCallback{
        public void foodIngredientsResultCallback(String jsonStringResult);
    }

    public FoodIngredientsAPI(Context context, String foodId){
        mContext = context;
        resultCallback =  (ResultCallback) mContext;
        this.foodId = foodId;
    }

    public FoodIngredientsAPI(Context context,String foodId,String language){
        mContext = context;
        resultCallback =  (ResultCallback) mContext;
        this.foodId = foodId;
    ...
    protected String doInBackground(String... url) {
        ...
        try {
            ...
            if(url != null && url.length>0){
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).foodIngredientsURL ;
                else
                    apiUrl = url[0];
    ...
    protected void onPostExecute(String jsonString) {
        ...
        resultCallback.foodIngredientsResultCallback(jsonString);
        Utils.setDebug("json FoodIngredientsAPI", jsonString);
    }
}
