...
public class SearchMenusByCuisineIdAPI extends AsyncTask<String, Void, String> {
    ...
    public  interface ResultCallback{
        public void searchMenusByCuisineIdResultCallback(String jsonStringResult);
    }

    public SearchMenusByCuisineIdAPI(Context context,String restaurantId,String CuisineID){
        mContext = context;
    ...
    protected String doInBackground(String... url) {
        ...
        try {
            ...
            if(url != null && url.length>0){
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).menuByCuisineUrl;
                else
                    apiUrl = url[0];
            ...
            nameValuePairs.add(new BasicNameValuePair("CuisineID", CuisineID));
    ...
    protected void onPostExecute(String jsonString) {
        ...
        Utils.setDebug("json SearchMenusByCuisineIdAPI", jsonString);
    }
}
