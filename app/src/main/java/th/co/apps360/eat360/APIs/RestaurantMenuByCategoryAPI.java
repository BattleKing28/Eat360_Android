...
public class RestaurantMenuByCategoryAPI extends AsyncTask<String, Void, String> {
    ...
    public  interface ResultCallback {
        void searchRestaurantMenuByCategoryCallback(String jsonStringResult);
    }

    public RestaurantMenuByCategoryAPI(Context context, String restaurantId, String CategoryID){
        mContext = context;
    ...
    protected String doInBackground(String... url) {
        ...
        try {
            ...
            if(url != null && url.length>0){
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).searchMenuByCategoryURL;
                else
                    apiUrl = url[0];
    ...
    protected void onPostExecute(String jsonString) {
        resultCallback.searchRestaurantMenuByCategoryCallback(jsonString);
        Utils.setDebug("json RestaurantMenuByCategoryAPI", jsonString);
