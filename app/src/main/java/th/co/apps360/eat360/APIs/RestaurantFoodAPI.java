...
public class RestaurantFoodAPI extends AsyncTask<String, Void, String> {
    ...
    public  interface ResultCallback {
        void searchRestaurantFoodResultCallback(String jsonStringResult);
    }

    public RestaurantFoodAPI(Context context, String restaurantId) {
        mContext = context;
    ...
    protected String doInBackground(String... url) {
        ...
        try {
            ...
            if(url != null && url.length>0){
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).restaurantFoodURL;
                else
                    apiUrl = url[0];
            }else
                apiUrl = new ConfigURL(mContext).restaurantFoodURL;
    ...
    protected void onPostExecute(String jsonString) {
        resultCallback.searchRestaurantFoodResultCallback(jsonString);
        Utils.setDebug("json RestaurantFoodAPI", jsonString);
    }
}
