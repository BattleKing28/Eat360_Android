...
// get food image
public class FoodImageAPI extends AsyncTask<String, Void, String> {
    ...
    public  interface ResultCallback{
        public void foodImageResultCallback(String jsonStringResult);
    }

    public FoodImageAPI(Context context,String foodId){
        mContext = context;
    ...
    protected String doInBackground(String... url) {
        ...
        try{
            ...
            if(url != null && url.length>0){
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).foodImageURL + "/" + foodId;
                else
                    apiUrl = url[0];
    ...
    protected void onPostExecute(String jsonString) {
        resultCallback.foodImageResultCallback(jsonString);
        Utils.setDebug("json FoodImageAPI", jsonString);
    }
