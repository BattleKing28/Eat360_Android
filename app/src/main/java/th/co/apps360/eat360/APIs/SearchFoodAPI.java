...
/**
 * Created by dan on 11/9/16.
 */

public class SearchFoodAPI extends AsyncTask<String, Void, String> {
    ...
    // SearchText, SearchLang, Latitude, Longitude, Radius, CuisineIDs, MealIDs, CategoryIDs, IngredientIDs, FoodCurrency
    public SearchFoodAPI(Context context, String searchText, String searchLang,
                         String latitude, String longitude, String radius,
                         String categoryIDs, String mealIDs, String cuisineIDs, String ingredientIDs, String foodCurrency) {
        mContext = context;
    ...
    protected String doInBackground(String... url) {
        ...
        try {
            ...
            if (url != null && url.length > 0) {
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).searchFoodURL;
                else
                    apiUrl = url[0];
            }
            else
            ...
            nameValuePairs.add(new BasicNameValuePair("IngredientIDs", ingredientIDs));
            nameValuePairs.add(new BasicNameValuePair("FoodCurrency", foodCurrency));
            nameValuePairs.add(new BasicNameValuePair("OnlyIDs", "false"));
    ...
    protected void onPostExecute(String jsonString) {
        ...
        Utils.setDebug("json SearchFoodAPI", jsonString);
    }
