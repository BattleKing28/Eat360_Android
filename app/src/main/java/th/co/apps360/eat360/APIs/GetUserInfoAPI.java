...
public class GetUserInfoAPI extends AsyncTask<String, Void, String> {
    ...
    public interface ResultCallback {
        void getUserInfoCallback(String jsonStringResult);
    }

    public GetUserInfoAPI(Context context, String token) {
        mContext = context;
        mToken = token;
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String apiUrl = new ConfigURL().getUserInfoURL;
    ...
    protected void onPostExecute(String jsonString) {
        resultCallback.getUserInfoCallback(jsonString);
        Utils.setDebug("json GetUserInfoAPI", jsonString);
    }
