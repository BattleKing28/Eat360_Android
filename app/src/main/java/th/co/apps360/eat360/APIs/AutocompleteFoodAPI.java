...
public class AutocompleteFoodAPI extends AsyncTask<String, Void, String> {
    ...
    public AutocompleteFoodAPI(Context context, String searchText,
                               String latitude, String longitude, String radius, String categoryIDs, String mealIDs, String cuisineIDs, String ingredientIDs){
        mContext = context;
    ...
    protected String doInBackground(String... url) {
        ...
        try {
            ...
            if(url != null && url.length>0){
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).autocompleteSearch_food;
                else
                    apiUrl = url[0];
            } else
                apiUrl = new ConfigURL(mContext).autocompleteSearch_food;
            ...
            nameValuePairs.add(new BasicNameValuePair("FoodCurrency", currency));
    ...
    protected void onPostExecute(String jsonString) {
        ...
        Utils.setDebug("json AutocompleteFoodAPI", jsonString);
