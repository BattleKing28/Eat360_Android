...
public class AutocompleteRestaurantAPI extends AsyncTask<String, Void, String> {
    ...
    public AutocompleteRestaurantAPI(Context context, String searchText, String latitude, String longitude, String radius, String facilityIDs, String cuisineIDs){
        mContext = context;
    ...
    protected void onPostExecute(String jsonString) {
        ...
        Utils.setDebug("json AutocompleteRestaurantAPI", jsonString);
    }
