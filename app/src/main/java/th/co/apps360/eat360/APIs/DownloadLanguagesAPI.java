...
public  class DownloadLanguagesAPI extends AsyncTask<String, Void, String> {
    ...
    public DownloadLanguagesAPI(Context context){
        mContext = context;
    ...
    protected String doInBackground(String... url) {
        ...
        try{
            ...
            if(url != null && url.length>0){
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).listLanguageURL;
                else
                    apiUrl = url[0];
    ...
    protected void onPostExecute(String jsonString) {
        ...
        resultCallback.downloadLanguageResultCallback(jsonString); 
        Utils.setDebug("json DownloadLanguagesAPI",jsonString);
    }
