...
public class UpdateUsernameAPI extends AsyncTask<String, Void, String> {
    ...
    public interface ResultCallback {
        void updateUsernameCallback(String jsonStringResult);
    }

    public UpdateUsernameAPI(Context context, String token, String firstname, String lastname) {
        mContext = context;
        mToken = token;
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String apiUrl = new ConfigURL().updateUserURL;
    ...
    protected void onPostExecute(String jsonString) {
        resultCallback.updateUsernameCallback(jsonString);
        Utils.setDebug("json UpdateUsernameAPI", jsonString);
    }
