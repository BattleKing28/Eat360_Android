...
import th.co.apps360.eat360.CustomView.CameraPreview;
...
public class QRScanActivity extends AppCompatActivity {
    ...
    private void initControls() {
        ...
        mPreview = new CameraPreview(QRScanActivity.this, mCamera, previewCb,
                autoFocusCB);
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            if (result != 0) {
                ...
                for (Symbol sym : syms) {
                    ...
                    MoreDataModel.qrscancode = scanResult;
