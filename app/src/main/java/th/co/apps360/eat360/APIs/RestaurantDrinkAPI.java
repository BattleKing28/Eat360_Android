...
public class RestaurantDrinkAPI extends AsyncTask<String, Void, String> {
    ...
    public  interface ResultCallback{
        void searchRestaurantDrinkResultCallback(String jsonStringResult);
    }

    public RestaurantDrinkAPI(Context context, String restaurantId){
        mContext = context;
    ...
    protected String doInBackground(String... url) {
        ...
        try {
            ...
            if(url != null && url.length>0){
                if(url[0] == null)
                    apiUrl = new ConfigURL(mContext).restaurantDrinkURL;
                else
                    apiUrl = url[0];
    ...
    protected void onPostExecute(String jsonString) {
        resultCallback.searchRestaurantDrinkResultCallback(jsonString);
        Utils.setDebug("json RestaurantDrinkAPI", jsonString);
